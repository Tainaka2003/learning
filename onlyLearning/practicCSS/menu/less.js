...
!function (e, t) {
    ...
    var n = function (t, n, i) {
        var r = i.href || "", o = "less:" + (i.title || e(r)), s = t.getElementById(o), a = !1,
    ...
    }, c = {colors: l, unitConversions: u}, h = function () {
        function e() {
    ...
    h.compare = function (e, t) {
        ...
        if (e.type === t.type) {
            ...
            if (e.length === t.length) {
                for (var n = 0; n < e.length; n++) if (0 !== h.compare(e[n], t[n])) return;
                return 0
            }
        }
    ...
    var f = function (e) {
        ...
        return o(t, e), t.prototype.luma = function () {
            ...
            var n, i, r, o = e && e.compress && !t, s = [];
            if (i = this.fround(e, this.alpha), this.value) if (0 === this.value.indexOf("rgb")) i < 1 && (r = "rgba"); else {
            ...
            var e, t, n = this.rgb[0] / 255, i = this.rgb[1] / 255, r = this.rgb[2] / 255, o = this.alpha,
                s = Math.max(n, i, r), a = Math.min(n, i, r), l = (s + a) / 2, u = s - a;
            if (s === a) e = t = 0; else {
            ...
            var e, t, n = this.rgb[0] / 255, i = this.rgb[1] / 255, r = this.rgb[2] / 255, o = this.alpha,
                s = Math.max(n, i, r), a = Math.min(n, i, r), l = s, u = s - a;
            if (t = 0 === s ? 0 : u / s, s === a) e = 0; else {
                switch (s) {
                    case n:
                        e = (i - r) / u + (i < r ? 6 : 0);
                        break;
            ...
            return v([255 * this.alpha].concat(this.rgb))
    ...
    f.prototype.type = "Color", f.fromKeyword = function (e) {
        var t, n = e.toLowerCase();
        if (l.hasOwnProperty(n) ? t = new f(l[n].slice(1)) : "transparent" === n && (t = new f([0, 0, 0], 0)), t) return t.value = e, t
    };
    var d = function (e) {
        function t(t) {
        ...
        return o(t, e), t.prototype.genCSS = function (e, t) {
    ...
    var y = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            var t = this.value;
            ...
            return t instanceof d && (e.firstSelector = !0), t = t.toCSS ? t.toCSS(e) : t, e.firstSelector = n, "" === t && "&" === this.combinator.value.charAt(0) ? "" : this.combinator.toCSS(e) + t
        }, t
    }(h);
    y.prototype.type = "Element";
    var b = {ALWAYS: 0, PARENS_DIVISION: 1, PARENS: 2, STRICT_LEGACY: 3}, w = 0, x = 1, S = 2;
    ...
    function A(e, t) {
        ...
        var n = _(e, t);
        if (n.strictMath && (n.math = b.STRICT_LEGACY), n.relativeUrls && (n.rewriteUrls = S), "string" == typeof n.math) switch (n.math.toLowerCase()) {
            case"always":
                n.math = b.ALWAYS;
                break;
    ...
    var P = Object.freeze({
        ...
        flattenArray: M
    }), E = /(<anonymous>|Function):(\d+):(\d+)/, R = function (e, t, n) {
        Error.call(this);
        var i = e.filename || n;
        if (this.message = e.message, this.stack = e.stack, t && i) {
            var r = t.contents[i], o = I(e.index, r), s = o.line, a = o.column, l = e.call && I(e.call, r).line,
                u = r ? r.split("\n") : "";
            if (this.type = e.type || "Syntax", this.filename = i, this.index = e.index, this.line = "number" == typeof s ? s + 1 : null, this.column = a, !this.line && this.stack) {
                var c = this.stack.match(E), h = new Function("a", "throw new Error()"), f = 0;
                try {
                    h()
                } catch (e) {
    ...
    R.prototype.constructor = R, R.prototype.toString = function (e) {
        void 0 === e && (e = {});
        var t = "", n = this.extract || [], i = [], r = function (e) {
            return e
        };
        if (e.stylize) {
    ...
    var F = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            return e ? ("string" == typeof e && this.parse.parseNode(e, ["selector"], this._index, this._fileInfo, (function (t, n) {
                if (t) throw new R({index: t.index, message: t.message}, this.parse.imports, this._fileInfo.filename);
                e = n[0].elements
            ...
            var t, n, i = this.elements, r = i.length;
            ...
            var t = this.condition && this.condition.eval(e), n = this.elements, i = this.extendList;
    ...
    O.prototype.type = "Keyword", O.True = new O("true"), O.False = new O("false");
    var L = function (e) {
        function t(t, n, i, r, o, s) {
            var a = e.call(this) || this;
        ...
        return o(t, e), t.prototype.eval = function () {
    ...
    var D = b, N = function (e) {
        function t(t, n, i, r, o, s, a, l) {
            var u = e.call(this) || this;
            return u.name = t, u.value = n instanceof h ? n : new $([n ? new L(n) : null]), u.important = i ? " " + i.trim() : "", u.merge = r, u._index = o, u._fileInfo = s, u.inline = a || !1, u.variable = void 0 !== l ? l : t.charAt && "@" === t.charAt(0), u.allowRoot = !0, u.setParent(u.value, u), u
        }
        ...
        return o(t, e), t.prototype.genCSS = function (e, t) {
            ...
            var n, i, r = !1, o = this.name, s = this.variable;
            "string" != typeof o && (o = 1 === o.length && o[0] instanceof O ? o[0].value : function (e, t) {
                var n, i = "", r = t.length, o = {
                    add: function (e) {
                        i += e
                    }
                };
                ...
                return i
            }(e, o), s = !1), "font" === o && e.math === D.ALWAYS && (r = !0, n = e.math, e.math = D.PARENS_DIVISION);
            try {
                ...
                var a = this.important, l = e.importantScope.pop();
    ...
    q.Parse = function (e) {
        j(e, this, T), "string" == typeof this.paths && (this.paths = [this.paths])
    };
    ...
    q.Eval = function () {
        function e(e, t) {
            j(e, this, z), "string" == typeof this.paths && (this.paths = [this.paths]), this.frames = t || [], this.importantScope = this.importantScope || [], this.inCalc = !1, this.mathOn = !0
        }
        ...
        return e.prototype.enterCalc = function () {
            ...
            return (this.rewriteUrls === x ? W : G)(e)
    ...
    var J = function e(t) {
        ...
        eval: function () {
            ...
            if (t) throw t;
            if (null != e) return e ? O.True : O.False
        }, value: function (e) {
            this.value_ = e
        }, error: function (e) {
            this.error_ = e
        ...
        return o(t, e), t.prototype.isRulesetLike = function () {
            return !0
            ...
            if (this.selectors && (i = this.selectors.length)) {
                for (n = new Array(i), H.error({
                    type: "Syntax",
                    message: "it is currently only allowed in parametric mixin guards,"
                }), o = 0; o < i; o++) {
                    r = this.selectors[o].eval(e);
                    for (var l = 0; l < r.elements.length; l++) if (r.elements[l].isVariable) {
                        s = !0;
                        break
                    }
            ...
            var c, f, p = this.rules ? C(this.rules) : null, v = new t(n, p, this.strictImports, this.visibilityInfo());
            v.originalRuleset = this, v.root = this.root, v.firstRoot = this.firstRoot, v.allowImports = this.allowImports, this.debugInfo && (v.debugInfo = this.debugInfo), a || (p.length = 0), v.functionRegistry = function (e) {
                for (var t, n = 0, i = e.length; n !== i; ++n) if (t = e[n].functionRegistry) return t;
                return J
            }(e.frames).inherit();
            var d = e.frames;
            d.unshift(v);
            ...
            })), g.splice.apply(g, [o, 1].concat(p)), o += p.length - 1, v.resetCache()) : "VariableCall" === c.type && (p = c.eval(e).rules.filter((function (e) {
                return !(e instanceof N && e.variable)
            })), g.splice.apply(g, [o, 1].concat(p)), o += p.length - 1, v.resetCache());
            for (o = 0; c = g[o]; o++) c.evalFirst || (g[o] = c = c.eval ? c.eval(e) : c);
            for (o = 0; c = g[o]; o++) if (c instanceof t && c.selectors && 1 === c.selectors.length && c.selectors[0] && c.selectors[0].isJustParentSelector()) {
                g.splice(o--, 1);
                for (l = 0; f = c.rules[l]; l++) f instanceof h && (f.copyVisibilityInfo(c.visibilityInfo()), f instanceof N && f.variable || g.splice(++o, 0, f))
            }
            if (d.shift(), m.shift(), e.mediaBlocks) for (o = y; o < e.mediaBlocks.length; o++) e.mediaBlocks[o].bubbleSelectors(n);
            return v
        }, t.prototype.evalImports = function (e) {
            var t, n, i = this.rules;
            if (i) for (t = 0; t < i.length; t++) "Import" === i[t].type && ((n = i[t].eval(e)) && (n.length || 0 === n.length) ? (i.splice.apply(i, [t, 1].concat(n)), t += n.length - 1) : i.splice(t, 1, n), this.resetCache())
        }, t.prototype.makeImportant = function () {
            ...
            return !!n.evaldCondition && !(n.condition && !n.condition.eval(new q.Eval(t, t.frames)))
            ...
            return this._variables || (this._variables = this.rules ? this.rules.reduce((function (e, t) {
                if (t instanceof N && !0 === t.variable && (e[t.name] = t), "Import" === t.type && t.root && t.root.variables) {
            ...
            return this._properties || (this._properties = this.rules ? this.rules.reduce((function (e, t) {
                if (t instanceof N && !0 !== t.variable) {
                    var n = 1 === t.name.length && t.name[0] instanceof O ? t.name[0].value : t.name;
            ...
            function n(e) {
                return e.value instanceof L && !e.parsed ? ("string" == typeof e.value.value ? this.parse.parseNode(e.value.value, ["value", "important"], e.value.getIndex(), e.fileInfo(), (function (t, n) {
            ...
            return s in this._lookups ? this._lookups[s] : (this.rulesets().forEach((function (s) {
                if (s !== t) for (var a = 0; a < s.selectors.length; a++) if (i = e.match(s.selectors[a])) {
            ...
            var l, u = e.compress ? "" : Array(e.tabLevel + 1).join("  "),
                c = e.compress ? "" : Array(e.tabLevel).join("  "), h = 0, f = 0;
            for (n = 0; o = this.rules[n]; n++) o instanceof U ? (f === n && f++, a.push(o)) : o.isCharset && o.isCharset() ? (a.splice(h, 0, o), h++, f++) : "Import" === o.type ? (a.splice(f, 0, o), f++) : a.push(o);
            if (a = [].concat(a), !this.root) {
                (r = B(e, this, c)) && (t.add(r), t.add(c));
                var p = this.paths, v = p.length, d = void 0;
                for (l = e.compress ? "," : ",\n" + c, n = 0; n < v; n++) if (d = (s = p[n]).length) for (n > 0 && t.add(l), e.firstSelector = !0, s[0].genCSS(e, t), e.firstSelector = !1, i = 1; i < d; i++) s[i].genCSS(e, t);
                t.add((e.compress ? "{" : " {\n") + u)
            }
            for (n = 0; o = a[n]; n++) {
            ...
            function i(e, t) {
                var n, i;
                if (0 === e.length) n = new d(e[0]); else {
            ...
            function r(e, t) {
                var n;
                return n = new y(null, e, t.isVariable, t._index, t._fileInfo), new F([n])
            }

            function o(e, t, n, i) {
                var r, o, s;
                if (r = [], e.length > 0 ? (o = (r = C(e)).pop(), s = i.createDerived(C(o.elements))) : s = i.createDerived([]), t.length > 0) {
                    var a = n.combinator, l = t[0].elements[0];
            ...
            function a(e, t) {
                var n, i;
                if (0 !== e.length) if (0 !== t.length) for (n = 0; i = t[n]; n++) i.length > 0 ? i[i.length - 1] = i[i.length - 1].createDerived(i[i.length - 1].elements.concat(e)) : i.push(new F(e)); else t.push([new F(e)])
            }
            ...
            var u, c;
            if (!function e(t, n, l) {
                var u, c, h, f, p, v, m, g, b, w, x, S, I = !1;
                for (f = [], p = [[]], u = 0; g = l.elements[u]; u++) if ("&" !== g.value) {
                    var C = (S = void 0, (x = g).value instanceof d && (S = x.value.value) instanceof F ? S : null);
                    if (null != C) {
                        a(f, p);
                        var k, _ = [], A = [];
                        for (k = e(_, n, C), I = I || k, h = 0; h < _.length; h++) {
                            s(p, [r(i(_[h], g), g)], g, l, A)
                        }
                        p = A, f = []
                    } else f.push(g)
                } else {
                    for (I = !0, v = [], a(f, p), c = 0; c < p.length; c++) if (m = p[c], 0 === n.length) m.length > 0 && m[0].elements.push(new y(g.combinator, "", g.isVariable, g._index, g._fileInfo)), v.push(m); else for (h = 0; h < n.length; h++) {
                        var M = o(m, n[h], g, l);
                        v.push(M)
                    }
                    p = v, f = []
                }
                for (a(f, p), u = 0; u < p.length; u++) (b = p[u].length) > 0 && (t.push(p[u]), w = p[u][b - 1], p[u][b - 1] = w.createDerived(w.elements, l.extendList));
                return I
            }(c = [], t, n)) if (t.length > 0) for (c = [], u = 0; u < t.length; u++) {
    ...
    var K = function (e) {
        function t(t, n, i, r, o, s, a, l) {
            ...
            if (c.name = t, c.value = n instanceof h ? n : n ? new L(n) : n, i) {
                for (Array.isArray(i) ? c.rules = i : (c.rules = [i], c.rules[0].selectors = new F([], null, null, r, o).createEmptySelectors()), u = 0; u < c.rules.length; u++) c.rules[u].allowImports = !0;
    ...
    var Y = function (e) {
        function t(t, n, i) {
            ...
            return r.numerator = t ? C(t).sort() : [], r.denominator = n ? C(n).sort() : [], i ? r.backupUnit = i : t && t.length && (r.backupUnit = t[0]), r
        }
        ...
        return o(t, e), t.prototype.clone = function () {
            ...
            for (e in this.numerator = [], this.denominator = [], n) if (n.hasOwnProperty(e)) {
                var i = n[e];
                if (i > 0) for (t = 0; t < i; t++) this.numerator.push(e); else if (i < 0) for (t = 0; t < -i; t++) this.denominator.push(e)
            }
    ...
    var X = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            var n = this.fround(e, this.value), i = String(n);
            ...
            var r = this._operate(e, n, this.value, i.value), o = this.unit.clone();
            if ("+" === n || "-" === n) if (0 === o.numerator.length && 0 === o.denominator.length) o = i.unit.clone(), this.unit.backupUnit && (o.backupUnit = this.unit.backupUnit); else if (0 === i.unit.numerator.length && 0 === o.denominator.length) ; else {
            ...
            var n, i;
            if (e instanceof t) {
                if (this.unit.isEmpty() || e.unit.isEmpty()) n = this, i = e; else if (n = this.unify(), i = e.unify(), 0 !== n.unit.compare(i.unit)) return;
                return h.numericCompare(n.value, i.value)
            }
        }, t.prototype.unify = function () {
            return this.convertTo({length: "px", duration: "s", angle: "rad"})
        }, t.prototype.convertTo = function (e) {
            var n, i, r, o, s, a = this.value, l = this.unit.clone(), c = {};
            if ("string" == typeof e) {
    ...
    var ee = b, te = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            var n, i = this.operands[0].eval(e), r = this.operands[1].eval(e);
            if (e.isMathOn(this.op)) {
                if (n = "./" === this.op ? "/" : this.op, i instanceof X && r instanceof f && (i = i.toColor()), r instanceof X && i instanceof f && (r = r.toColor()), !i.operate) {
                    if (i instanceof t && "/" === i.op && e.math === ee.PARENS_DIVISION) return new t(this.op, [i, r], this.isSpaced);
    ...
    var ne = b, ie = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            var n, i = e.isMathOn(), r = this.parens && (e.math !== ne.STRICT_LEGACY || !this.parensInOp), o = !1;
            return r && e.inParenthesis(), this.value.length > 1 ? n = new t(this.value.map((function (t) {
                return t.eval ? t.eval(e) : t
            })), this.noSpacing) : 1 === this.value.length ? (!this.value[0].parens || this.value[0].parensInOp || e.inCalc || (o = !0), n = this.value[0].eval(e)) : n = this, r && e.outOfParenthesis(), !this.parens || !this.parensInOp || i || o || n instanceof X || (n = new d(n)), n
        }, t.prototype.genCSS = function (e, t) {
    ...
    var re = function () {
        ...
        return e.prototype.isValid = function () {
            ...
            var t = this, n = this.func.evalArgs;
            return !1 !== n && (e = e.map((function (e) {
                ...
                return e
            }))), !1 === n ? this.func.apply(this, a([this.context], e)) : this.func.apply(this, e)
        }, e
    }(), oe = function (e) {
        function t(t, n, i, r) {
            var o = e.call(this) || this;
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            if (s.isValid()) {
                ...
                if (null != r) return r instanceof h || (r = new L(r && !0 !== r ? r.toString() : null)), r._index = this._index, r._fileInfo = this._fileInfo, r
            }
            var a = this.args.map((function (t) {
                return t.eval(e)
            }));
            return o(), new t(this.name, a, this.getIndex(), this.fileInfo())
        }, t.prototype.genCSS = function (e, t) {
    ...
    var se = function (e) {
        ...
        return o(t, e), t.prototype.eval = function (e) {
            var n, i = this.name;
    ...
    var ae = function (e) {
        ...
        return o(t, e), t.prototype.eval = function (e) {
            var t, n = this.name, i = e.pluginManager.less.visitors.ToCSSVisitor.prototype._mergeRules;
            ...
            if (this.evaluating = !0, t = this.find(e.frames, (function (t) {
                ...
                if (o) {
                    for (var s = 0; s < o.length; s++) r = o[s], o[s] = new N(r.name, r.value, r.important, r.merge, r.index, r.currentFileInfo, r.inline, r.variable);
                    if (i(o), (r = o[o.length - 1]).important) e.importantScope[e.importantScope.length - 1].important = r.important;
    ...
    var he = function (e) {
        function t(t, n, i, r, o) {
            ...
            return s.features = new $(n), s.rules = [new Q(a, t)], s.rules[0].allowImports = !0, s.copyVisibilityInfo(o), s.allowRoot = !0, s.setParent(a, s), s.setParent(s.features, s), s.setParent(s.rules, s), s
        }
        ...
        return o(t, e), t.prototype.isRulesetLike = function () {
            ...
            if (e.mediaBlocks.length > 1) {
                ...
                (t = new Q(n, e.mediaBlocks)).multiMedia = !0, t.copyVisibilityInfo(this.visibilityInfo()), this.setParent(t, this)
            }
            return delete e.mediaBlocks, delete e.mediaPath, t
        }, t.prototype.evalNested = function (e) {
            var t, n, i = e.mediaPath.concat([this]);
            for (t = 0; t < i.length; t++) n = i[t].features instanceof $ ? i[t].features.value : i[t].features, i[t] = Array.isArray(n) ? n : [n];
            return this.features = new $(this.permute(i).map((function (e) {
                for (e = e.map((function (e) {
                    return e.toCSS ? e : new L(e)
                })), t = e.length - 1; t > 0; t--) e.splice(t, 0, new L("and"));
                return new ie(e)
            }))), this.setParent(this.features, this), new Q([], [])
        }, t.prototype.permute = function (e) {
            if (0 === e.length) return [];
            if (1 === e.length) return e[0];
            for (var t = [], n = this.permute(e.slice(1)), i = 0; i < n.length; i++) for (var r = 0; r < e[0].length; r++) t.push([e[0][r]].concat(n[i]));
            return t
    ...
    var fe = function (e) {
        function t(t, n, i, r, o, s) {
            var a = e.call(this) || this;
            if (a.options = i, a._index = r, a._fileInfo = o, a.path = t, a.features = n, a.allowRoot = !0, void 0 !== a.options.less || a.options.inline) a.css = !a.options.less || a.options.inline; else {
                var l = a.getPath();
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            var n = this.path;
            return n instanceof ce && (n = n.value), new t(n.eval(e), this.features, this.options, this._index, this._fileInfo, this.visibilityInfo())
        }, t.prototype.evalPath = function (e) {
            var t = this.path.eval(e), n = this._fileInfo;
            if (!(t instanceof ce)) {
                var i = t.value;
            ...
            if (this.options.isPlugin) {
                if (this.root && this.root.eval) try {
                    ...
                    throw e.message = "Plugin error during evaluation", new R(e, this.root.imports, this.root.filename)
                }
            ...
            return this.root ? ((n = new Q(null, C(this.root.rules))).evalImports(e), this.features ? new he(n.rules, this.features.value) : n.rules) : []
        }, t
    }(h);
    ...
    var pe = function (e) {
        ...
        return o(t, e), t.prototype.eval = function (e) {
            var t = this.evaluateJavaScript(this.expression, e), n = typeof t;
            return "number" !== n || isNaN(t) ? "string" === n ? new ue('"' + t + '"', t, this.escaped, this._index) : Array.isArray(t) ? new L(t.join(", ")) : new L(t) : new X(t)
        }, t
    }(function (e) {
        function t() {
        ...
        return o(t, e), t.prototype.evaluateJavaScript = function (e, t) {
            var n, i = this, r = {};
    ...
    var ge = function (e) {
        ...
        return o(t, e), t.prototype.genCSS = function (e, t) {
            ...
            return e.isMathOn() ? new te("*", [new X(-1), this.value]).eval(e) : new t(this.value.eval(e))
        }, t
    }(h);
    ...
    var ye = function (e) {
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            this.selfSelectors = [new F(i)], this.selfSelectors[0].copyVisibilityInfo(this.visibilityInfo())
        }, t
    }(h);
    ...
    var be = function (e) {
        ...
        return o(t, e), t.prototype.eval = function (e) {
            var t, n = new se(this.variable, this.getIndex(), this.fileInfo()).eval(e),
                i = new R({message: "Could not evaluate variable call " + this.variable});
            if (!n.ruleset) {
                if (n.rules) t = n; else if (Array.isArray(n)) t = new Q("", n); else {
    ...
    var we = function (e) {
        ...
        return o(t, e), t.prototype.eval = function (e) {
            ...
            for (t = 0; t < this.lookups.length; t++) {
                if (n = this.lookups[t], Array.isArray(i) && (i = new Q([new F], i)), "" === n) i = i.lastDeclaration(); else if ("@" === n.charAt(0)) {
                    if ("@" === n.charAt(1) && (n = "@" + new se(n.substr(1)).eval(e).value), i.variables && (i = i.variable(n)), !i) throw{
                        type: "Name",
                    ...
                    if (n = "$@" === n.substring(0, 2) ? "$" + new se(n.substr(1)).eval(e).value : "$" === n.charAt(0) ? n : "$" + n, i.properties && (i = i.property(n)), !i) throw{
                        type: "Name",
    ...
    var xe = function (e) {
        function t(t, n, i, r, o, s, a) {
            ...
            l.name = t || "anonymous mixin", l.selectors = [new F([new y(null, t, !1, l._index, l._fileInfo)])], l.params = n, l.condition = r, l.variadic = o, l.arity = n.length, l.rules = i, l._lookups = {};
            var u = [];
        ...
        return o(t, e), t.prototype.accept = function (e) {
            ...
            var r, o, s, a, l, u, c, h, f = new Q(null, null), p = C(this.params), v = 0;
            if (t.frames && t.frames[0] && t.frames[0].functionRegistry && (f.functionRegistry = t.frames[0].functionRegistry.inherit()), t = new q.Eval(t, [f].concat(t.frames)), n) for (v = (n = C(n)).length, s = 0; s < v; s++) if (u = (o = n[s]) && o.name) {
                for (c = !1, a = 0; a < p.length; a++) if (!i[a] && u === p[a].name) {
                ...
                throw{type: "Runtime", message: "Named argument for " + this.name + " " + n[s].name + " not found"}
            }
            for (h = 0, s = 0; s < p.length; s++) if (!i[s]) {
                if (o = n && n[h], u = p[s].name) if (p[s].variadic) {
                    for (r = [], a = h; a < v; a++) r.push(n[a].value.eval(e));
                    f.prependRule(new N(u, new ie(r).eval(e)))
                } else {
                    if (l = o && o.value) l = Array.isArray(l) ? new Z(new Q("", l)) : l.eval(e); else {
                        if (!p[s].value) throw{
                            type: "Runtime",
            ...
            return new t(this.name, this.params, this.rules, this.condition, this.variadic, this.frames || C(e.frames))
        }, t.prototype.evalCall = function (e, t, n) {
            var i, r, o = [], s = this.frames ? this.frames.concat(e.frames) : e.frames,
                a = this.evalParams(e, new q.Eval(e, s), t, o);
            return a.prependRule(new N("@arguments", new ie(o).eval(e))), i = C(this.rules), (r = new Q(null, i)).originalRuleset = this, r = r.eval(new q.Eval(e, [this, a].concat(s))), n && (r = r.makeImportant()), r
        }, t.prototype.matchCondition = function (e, t) {
            ...
            var n, i = e && e.length || 0, r = this.optionalParameters, o = e ? e.reduce((function (e, t) {
            ...
            for (var s = 0; s < n; s++) if (!this.params[s].name && !this.params[s].variadic && e[s].value.eval(t).toCSS() != this.params[s].value.eval(t).toCSS()) return !1;
            return !0
        }, t
    }(Q);
    ...
    var Se = function (e) {
        function t(t, n, i, r, o) {
            var s = e.call(this) || this;
            return s.selector = new F(t), s.arguments = n || [], s._index = i, s._fileInfo = r, s.important = o, s.allowRoot = !0, s.setParent(s.selector, s), s
        }

        return o(t, e), t.prototype.accept = function (e) {
            this.selector && (this.selector = e.visit(this.selector)), this.arguments.length && (this.arguments = e.visitArray(this.arguments))
        }, t.prototype.eval = function (e) {
            var t, n, i, r, o, s, a, l, u, c, h, f, p, v, d, m = [], g = [], y = !1, b = [], w = [];

            function x(t, n) {
                var i, r, o;
                for (i = 0; i < 2; i++) {
                    for (w[i] = !0, H.value(i), r = 0; r < n.length && w[i]; r++) (o = n[r]).matchCondition && (w[i] = w[i] && o.matchCondition(null, e));
                    t.matchCondition && (w[i] = w[i] && t.matchCondition(m, e))
                }
                return w[0] || w[1] ? w[0] != w[1] ? w[1] ? 1 : 2 : 0 : -1
            }

            for (this.selector = this.selector.eval(e), s = 0; s < this.arguments.length; s++) if (o = (r = this.arguments[s]).value.eval(e), r.expand && Array.isArray(o.value)) for (o = o.value, a = 0; a < o.length; a++) m.push({value: o[a]}); else m.push({
                name: r.name,
                value: o
            });
            for (d = function (t) {
                return t.matchArgs(null, e)
            }, s = 0; s < e.frames.length; s++) if ((t = e.frames[s].find(this.selector, null, d)).length > 0) {
                for (c = !0, a = 0; a < t.length; a++) {
                    for (n = t[a].rule, i = t[a].path, u = !1, l = 0; l < e.frames.length; l++) if (!(n instanceof xe) && n === (e.frames[l].originalRuleset || e.frames[l])) {
                        u = !0;
                        break
                    }
                    u || n.matchArgs(m, e) && (-1 !== (h = {mixin: n, group: x(n, i)}).group && b.push(h), y = !0)
                }
                ...
                for (a = 0; a < b.length; a++) if (0 === (h = b[a].group) || h === f) try {
                    (n = b[a].mixin) instanceof xe || (v = n.originalRuleset || n, (n = new xe("", [], n.rules, null, !1, null, v.visibilityInfo())).originalRuleset = v);
    ...
    var Ie = {
        ...
        return e.prototype.getFileManager = function (e, t, n, i, r) {
            e || Ce.warn("getFileManager called with no filename.. Please report this issue. continuing."), null == t && Ce.warn("getFileManager called with null directory.. Please report this issue. continuing.");
        ...
        return e.prototype.getPath = function (e) {
            ...
            var n, i, r, o, s = this.extractUrlParts(e), a = this.extractUrlParts(t), l = "";
            ...
            if (o[3]) for (a = o[3].replace(/\\/g, "/").split("/"), n = 0; n < a.length; n++) ".." === a[n] ? l.pop() : "." !== a[n] && l.push(a[n]);
        ...
        return e.prototype.evalPlugin = function (e, t, n, i, r) {
            ...
            if (l.addPlugin(s, r.filename, o), s.functions = o.getLocalFunctions(), c = this.trySetOptions(s, u, h, i)) return c;
            try {
                s.use && s.use.call(this.context, s)
            } catch (e) {
                return e.message = e.message || "Error during @plugin call", new R(e, n, u)
            ...
            if (i && !e.setOptions) return new R({message: "Options have been provided but the plugin " + n + " does not support any options."});
            try {
            ...
            return e ? ("function" == typeof e && (e = new e), e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0 ? new R({message: "Plugin " + n + " requires version " + this.versionToString(e.minVersion)}) : e) : null
        }, e.prototype.compareVersion = function (e, t) {
            "string" == typeof e && (e = e.match(/^(\d+)\.?(\d+)?\.?(\d+)?/)).shift();
            for (var n = 0; n < e.length; n++) if (e[n] !== t[n]) return parseInt(e[n]) > parseInt(t[n]) ? -1 : 1;
            return 0
    ...
    var Re = function () {
        function e(e) {
            this._implementation = e, this._visitInCache = {}, this._visitOutCache = {}, Pe || (!function e(t, n) {
                var i, r;
        ...
        return e.prototype.visit = function (e) {
            ...
            var n, i = this._implementation, r = this._visitInCache[t], o = this._visitOutCache[t], s = Me;
            if (s.visitDeeper = !0, r || (r = i[n = "visit" + e.type] || Ee, o = i[n + "Out"] || Ee, this._visitInCache[t] = r, this._visitOutCache[t] = o), r !== Ee) {
                var a = r.call(i, e, s);
                e && i.isReplacing && (e = a)
            }
            if (s.visitDeeper && e) if (e.length) for (var l = 0, u = e.length; l < u; l++) e[l].accept && e[l].accept(this); else e.accept && e.accept(this);
            ...
            var n, i, r, o, s, a;
            for (t || (t = []), i = 0, n = e.length; i < n; i++) if (void 0 !== (r = e[i])) if (r.splice) for (s = 0, o = r.length; s < o; s++) void 0 !== (a = r[s]) && (a.splice ? a.length && this.flatten(a, t) : t.push(a)); else t.push(r);
            return t
        }, e
    }(), Ve = function () {
        function e(e) {
        ...
        this._visitor = new Re(this), this._importer = e, this._finish = t, this.context = new q.Eval, this.importCount = 0, this.onceFileDetectionMap = {}, this.recursionDetector = {}, this._sequencer = new Ve(this._onSequencerEmpty.bind(this))
    };
    Fe.prototype = {
        isReplacing: !1, run: function (e) {
            ...
            if (!e.css || n) {
                var i = new q.Eval(this.context, C(this.context.frames)), r = i.frames[0];
            ...
            if (!i || i.css && !r) this.importCount--, this.isFinished && this._sequencer.tryRun(); else {
                i.options.multiple && (t.importMultiple = !0);
                for (var o = void 0 === i.css, s = 0; s < n.rules.length; s++) if (n.rules[s] === e) {
                    n.rules[s] = i;
                    break
                }
                var a = this.onImported.bind(this, i, t), l = this._sequencer.addImport(a);
            ...
            var s = this, a = e.options.inline, l = e.options.isPlugin, u = e.options.optional,
    ...
    var $e = function () {
        ...
        return e.prototype.run = function (e) {
            ...
            if (!e.root) {
                var n, i, r, o, s = [], a = e.rules, l = a ? a.length : 0;
                for (n = 0; n < l; n++) e.rules[n] instanceof Ie.Extend && (s.push(a[n]), e.extendOnEveryPath = !0);
                var u = e.paths;
                for (n = 0; n < u.length; n++) {
                    var c = u[n], h = c[c.length - 1].extendList;
                    for ((o = h ? C(h).concat(s) : s) && (o = o.map((function (e) {
                        return e.clone()
        ...
        return e.prototype.run = function (e) {
            ...
            e.filter((function (e) {
                ...
                t[e.index + " " + n] || (t[e.index + " " + n] = !0, Ce.warn("extend '" + n + "' has no matches"))
            }))
        }, e.prototype.doExtendChaining = function (e, t, n) {
            var i, r, o, s, a, l, u, c, h = [], f = this;
            for (n = n || 0, i = 0; i < e.length; i++) for (r = 0; r < t.length; r++) l = e[i], u = t[r], l.parent_ids.indexOf(u.object_id) >= 0 || (a = [u.selfSelectors[0]], (o = f.findMatch(l, a)).length && (l.hasFoundMatches = !0, l.selfSelectors.forEach((function (e) {
            ...
            if (h.length) {
                if (this.extendChainCount++, n > 100) {
                    var p = "{unable to calculate}", v = "{unable to calculate}";
                    try {
                        p = h[0].selfSelectors[0].toCSS(), v = h[0].selector.toCSS()
                    } catch (e) {
                    }
                    throw{message: "extend circular reference detected. One of the circular extends is currently:" + p + ":extend(" + v + ")"}
                }
            ...
            if (!e.root) {
                var n, i, r, o, s = this.allExtendsStack[this.allExtendsStack.length - 1], a = [], l = this;
                for (r = 0; r < s.length; r++) for (i = 0; i < e.paths.length; i++) if (o = e.paths[i], !e.extendOnEveryPath) {
            ...
            var r, o, s, a, l, u = 0, c = 0, h = [];
            for (r = 0; r < e.length; r++) o = t[(a = e[r]).pathIndex], s = new Ie.Element(a.initialCombinator, n.elements[0].value, n.elements[0].isVariable, n.elements[0].getIndex(), n.elements[0].fileInfo()), a.pathIndex > u && c > 0 && (h[h.length - 1].elements = h[h.length - 1].elements.concat(t[u].elements.slice(c)), c = 0, u++), l = o.elements.slice(c, a.index).concat([s]).concat(n.elements.slice(1)), u === a.pathIndex && r > 0 ? h[h.length - 1].elements = h[h.length - 1].elements.concat(l) : (h = h.concat(t.slice(u, a.pathIndex))).push(new Ie.Selector(l)), u = a.endPathIndex, (c = a.endPathElementIndex) >= t[u].elements.length && (c = 0, u++);
        ...
        return e.prototype.run = function (e) {
            ...
            var n, i = this.contexts[this.contexts.length - 1], r = [];
        ...
        return e.prototype.containsSilentNonBlockedChild = function (e) {
            var t;
            if (!e) return !1;
            for (var n = 0; n < e.length; n++) if ((t = e[n]).isSilent && t.isSilent(this._context) && !t.blocksVisibility()) return !0;
            return !1
    ...
    Be.prototype = {
        isReplacing: !0, run: function (e) {
            ...
            if (e) for (var n = 0; n < e.length; n++) {
                var i = e[n];
                if (t && i instanceof Ie.Declaration && !i.variable) throw{
                    message: "Properties must be inside selector blocks. They cannot be in the root",
                    index: i.getIndex(),
                    filename: i.fileInfo() && i.fileInfo().filename
                };
                if (i instanceof Ie.Call) throw{
            ...
            e.paths && (e.paths = e.paths.filter((function (e) {
                var t;
                for (" " === e[0].elements[0].combinator.value && (e[0].elements[0].combinator = new Ie.Combinator("")), t = 0; t < e.length; t++) if (e[t].isVisible() && e[t].getIsOutput()) return !0;
                return !1
            })))
        }, _removeDuplicateRules: function (e) {
            if (e) {
                var t, n, i, r = {};
                for (i = e.length - 1; i >= 0; i--) if ((n = e[i]) instanceof Ie.Declaration) if (r[n.name]) {
                    (t = r[n.name]) instanceof Ie.Declaration && (t = r[n.name] = [r[n.name].toCSS(this._context)]);
            ...
            if (e) {
                ...
                n.forEach((function (e) {
                    if (e.length > 0) {
                        var t = e[0], n = [], i = [new Ie.Expression(n)];
                        e.forEach((function (e) {
                            "+" === e.merge && n.length > 0 && i.push(new Ie.Expression(n = [])), n.push(e.value), t.important = t.important || e.important
    ...
    var Ue = {
        ...
        function u(n) {
            for (var i, a, c, h = l.i, f = t, p = l.i - s, v = l.i + o.length - p, d = l.i += n, m = e; l.i < v; l.i++) {
        ...
        return l.save = function () {
            ...
            var n = l.i + (t || 0), i = e.charCodeAt(n);
            ...
            for (var n = t.length, i = 0; i < n; i++) if (e.charAt(l.i + i) !== t.charAt(i)) return null;
            return u(n), t
        }, l.$quoted = function (t) {
            var n = t || l.i, i = e.charAt(n);
            if ("'" === i || '"' === i) {
            ...
            var n, i = "", r = null, o = !1, s = 0, a = [], c = [], h = e.length, f = l.i, p = l.i, v = l.i, d = !0;
            ...
            do {
                var m = e.charAt(v);
                if (0 === s && n(m)) (r = e.substr(p, v - p)) ? c.push(r) : c.push(" "), r = c, u(v - f), d = !1; else {
                    if (o) {
                    ...
                    switch (m) {
                        ...
                        case"'":
                        case'"':
                            (i = l.$quoted(v)) ? (c.push(e.substr(p, v - p), i), p = (v += i[1].length - 1) + 1) : (u(v - f), r = m, d = !1);
                            break;
                        case"{":
                            a.push("}"), s++;
                            break;
            ...
            e = i, l.i = t = s = n = 0, r = a ? function (e, t) {
                var n, i, r, o, s, a, l, u, c, h = e.length, f = 0, p = 0, v = [], d = 0;
                ...
                for (s = 0; s < h; s++) if (!((l = e.charCodeAt(s)) >= 97 && l <= 122 || l < 34)) switch (l) {
                    case 40:
                        p++, i = s;
                        continue;
                    case 41:
                    ...
                    case 39:
                    case 96:
                        for (c = 0, a = s, s += 1; s < h; s++) if (!((u = e.charCodeAt(s)) > 96)) {
                            if (u == l) {
                                c = 1;
                                break
                            }
                    ...
                    case 47:
                        if (p || s == h - 1) continue;
                        if (47 == (u = e.charCodeAt(s + 1))) for (s += 2; s < h && (!((u = e.charCodeAt(s)) <= 13) || 10 != u && 13 != u); s++) ; else if (42 == u) {
                            for (r = a = s, s += 2; s < h - 1 && (125 == (u = e.charCodeAt(s)) && (o = s), 42 != u || 47 != e.charCodeAt(s + 1)); s++) ;
                ...
                return 0 !== f ? t(r > n && o > r ? "missing closing `}` or `*/`" : "missing closing `}`", n) : 0 !== p ? t("missing closing `)`", i) : (m(!0), v)
            }(i, c) : [i], o = r[0], u(0)
        }, l.end = function () {
        ...
        return {
            parserInput: o, imports: n, fileInfo: i, parseNode: function (e, t, i, s, a) {
                var l, u = [], c = o;
                try {
                    c.start(e, !1, (function (e, t) {
                        a({message: e, index: t + i})
                    }));
                    for (var h = 0, f = void 0, p = void 0; f = t[h]; h++) if (p = c.i, l = r[f]()) {
                        try {
                            l._index = p + i, l._fileInfo = s
                        } catch (e) {
                        }
                        u.push(l)
                    } else u.push(null);
                ...
                var l, u, c, h, f = null, p = "";
                if (u = a && a.globalVars ? e.serializeVars(a.globalVars) + "\n" : "", c = a && a.modifyVars ? "\n" + e.serializeVars(a.modifyVars) : "", t.pluginManager) for (var v = t.pluginManager.getPreProcessors(), d = 0; d < v.length; d++) r = v[d].process(r, {
                    context: t,
                    imports: n,
                    fileInfo: i
                });
                ...
                try {
                    ...
                    })), Ie.Node.prototype.parse = this, l = new Ie.Ruleset(null, this.parsers.primary()), Ie.Node.prototype.rootNode = l, l.root = !0, l.firstRoot = !0, l.functionRegistry = J.inherit()
                } catch (e) {
                ...
                if (!m.isFinished) {
                    ...
                    g || (g = "Unrecognised input", "}" === m.furthestChar ? g += ". Possibly missing opening '{'" : ")" === m.furthestChar ? g += ". Possibly missing opening '('" : m.furthestReachedEnd && (g += ". Possibly missing something")), f = new R({
                        type: "Parse",
                        message: g,
                        index: m.furthest,
                        filename: i.filename
                ...
                var y = function (e) {
                    return (e = f || e || n.error) ? (e instanceof R || (e = new R(e, n, i.filename)), s(e)) : s(null, l)
                };
                ...
                primary: function () {
                    for (var e, t = this.mixin, n = []; ;) {
                        ...
                        if (o.finished) break;
                        if (o.peek("}")) break;
                        if (e = this.extendRule()) n = n.concat(e); else if (e = t.definition() || this.declaration() || t.call(!1, !1) || this.ruleset() || this.variableCall() || this.entities.call() || this.atrule()) n.push(e); else {
                    ...
                    mixinLookup: function () {
                        ...
                        var t, n = o.i, r = !1;
                        if (o.save(), o.$char("~")) r = !0; else if (e) return void o.restore();
                        if (t = o.$quoted()) return o.forget(), new Ie.Quoted(t.charAt(0), t.substr(1, t.length - 2), r, n, i);
                        o.restore()
                    }, keyword: function () {
                        ...
                        var e, t, n, r = o.i;
                        if (!o.peek(/^url\(/i)) if (o.save(), e = o.$re(/^([\w-]+|%|progid:[\w\.]+)\(/)) {
                            if (e = e[1], (n = this.customFuncCall(e)) && (t = n.parse()) && n.stop) return o.forget(), t;
                            if (t = this.arguments(t), o.$char(")")) return o.forget(), new Ie.Call(e, t, r, i);
                        ...
                        for (o.save(); ;) {
                            ...
                            o.$char(",") || (o.$char(";") || t) && (t = !0, n = i.length < 1 ? i[0] : new Ie.Value(i), s.push(n), i = [])
                        }
                        ...
                        var e, t;
                        if (o.save(), e = o.$re(/^\w+(?=\s?=)/i)) if (o.$char("=")) {
                            if (t = r.entity()) return o.forget(), new Ie.Assignment(e, t);
                            o.restore()
                        } else o.restore(); else o.restore()
                    }, url: function () {
                        var e, t = o.i;
                        if (o.autoCommentAbsorb = !1, o.$str("url(")) return e = this.quoted() || this.variable() || this.property() || o.$re(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || "", o.autoCommentAbsorb = !0, l(")"), new Ie.URL(null != e.value || e instanceof Ie.Variable || e instanceof Ie.Property ? e : new Ie.Anonymous(e, t), t, i);
                        ...
                        var e, t = o.i;
                        if ("@" === o.currentChar() && (e = o.$re(/^@\{([\w-]+)\}/))) return new Ie.Variable("@" + e[1], t, i)
                    }, property: function () {
                        var e, t = o.i;
                        if ("$" === o.currentChar() && (e = o.$re(/^\$[\w-]+/))) return new Ie.Property(e, t, i)
                    }, propertyCurly: function () {
                        var e, t = o.i;
                        if ("$" === o.currentChar() && (e = o.$re(/^\$\{([\w-]+)\}/))) return new Ie.Property("$" + e[1], t, i)
                    }, color: function () {
                        var e;
                        if (o.save(), "#" === o.currentChar() && (e = o.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#\[])?/)) && !e[2]) return o.forget(), new Ie.Color(e[1], void 0, e[0]);
                        o.restore()
                        ...
                        var e;
                        if (e = o.$re(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/)) return new Ie.UnicodeDescriptor(e[0])
                    }, javascript: function () {
                        var e, t = o.i;
                        o.save();
                        var n = o.$char("~");
                        if (o.$char("`")) {
                            if (e = o.$re(/^[^`]*`/)) return o.forget(), new Ie.JavaScript(e.substr(0, e.length - 1), Boolean(n), t, i);
                    ...
                    if (o.save(), a || "@" === o.currentChar() && (a = o.$re(/^(@[\w-]+)(\(\s*\))?/))) {
                        ...
                        return !s && r.end() ? (o.forget(), l) : (o.forget(), new Ie.NamespaceValue(l, t, n, i))
                    }
                    o.restore()
                }, extend: function (e) {
                    var t, n, r, l, u, c = o.i;
                    if (o.$str(e ? "&:extend(" : ":extend(")) {
                        do {
                            ...
                            r = r && r[1], t || s("Missing target selector for :extend()."), u = new Ie.Extend(new Ie.Selector(t), r, c, i), l ? l.push(u) : l = [u]
                        } while (o.$char(","));
                        return a(/^\)/), e && a(/^;/), l
                    }
                }, extendRule: function () {
                    ...
                    call: function (e, t) {
                        var n, s, a, u, c = o.currentChar(), h = !1, f = o.i;
                        if ("." === c || "#" === c) {
                        ...
                        for (var e, t, n, r, s, a = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/; s = o.i, t = o.$re(a);) r = new Ie.Element(n, t, !1, s, i), e ? e.push(r) : e = [r], n = o.$char(">");
                        return e
                    }, args: function (e) {
                        var t, n, i, a, l, u, c, h = r.entities, f = {args: null, variadic: !1}, p = [], v = [], d = [],
                            m = !0;
                        for (o.save(); ;) {
                            if (e) u = r.detachedRuleset() || r.expression(); else {
                                if (o.commentStore.length = 0, o.$str("...")) {
                                    f.variadic = !0, o.$char(";") && !t && (t = !0), (t ? v : d).push({variadic: !0});
                                    break
                                }
                            ...
                            var g = null;
                            if (e ? u.value && 1 == u.value.length && (g = u.value[0]) : g = u, g && (g instanceof Ie.Variable || g instanceof Ie.Property)) if (o.$char(":")) {
                                ...
                                if (!e) {
                                    f.variadic = !0, o.$char(";") && !t && (t = !0), (t ? v : d).push({
                                        name: u.name,
                                        variadic: !0
                                    });
                                    break
                            ...
                            l && p.push(l), d.push({
                                ...
                                value: l,
                                expand: c
                            }), o.$char(",") ? m = !0 : ((m = ";" === o.$char(";")) || t) && (n && s("Cannot mix ; and , as delimiter types"), t = !0, p.length > 1 && (l = new Ie.Value(p)), v.push({
                                name: i,
                                value: l,
                                expand: c
                            }), i = null, p = [], n = !1)
                        ...
                        var e, t, n, i, s = [], l = !1;
                        if (!("." !== o.currentChar() && "#" !== o.currentChar() || o.peek(/^[^{]*\}/))) if (o.save(), t = o.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                            e = t[1];
                            var u = this.args(!1);
                            if (s = u.args, l = u.variadic, !o.$char(")")) return void o.restore("Missing closing ')'");
                            if (o.commentStore.length = 0, o.$str("when") && (i = a(r.conditions, "expected condition")), n = r.block()) return o.forget(), new Ie.mixin.Definition(e, s, n, i, l);
                            o.restore()
                        } else o.restore()
                    ...
                    var e;
                    if (o.$re(/^opacity=/i)) return (e = o.$re(/^\d+/)) || (e = "@{" + (e = a(r.entities.variable, "Could not parse alpha")).name.slice(1) + "}"), l(")"), new Ie.Quoted("", "alpha(opacity=" + e + ")")
                }, element: function () {
                    var e, t, n, r = o.i;
                    if (t = this.combinator(), (e = o.$re(/^(?:\d+\.\d+|\d+)%/) || o.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || o.$char("*") || o.$char("&") || this.attribute() || o.$re(/^\([^&()@]+\)/) || o.$re(/^[\.#:](?=@)/) || this.entities.variableCurly()) || (o.save(), o.$char("(") ? (n = this.selector(!1)) && o.$char(")") ? (e = new Ie.Paren(n), o.forget()) : o.restore("Missing closing ')'") : o.forget()), e) return new Ie.Element(t, e, e instanceof Ie.Variable, r, i)
                }, combinator: function () {
                    var e = o.currentChar();
                    if ("/" === e) {
                        o.save();
                    ...
                    var t, n, r, l, u, c, h, f = o.i;
                    for (e = !1 !== e; (e && (n = this.extend()) || e && (c = o.$str("when")) || (l = this.element())) && (c ? h = a(this.conditions, "expected condition") : h ? s("CSS guard can only be used at the end of selector") : n ? u = u ? u.concat(n) : n : (u && s("Extend can only be used at the end of selector"), r = o.currentChar(), t ? t.push(l) : t = [l], l = null), "{" !== r && "}" !== r && ";" !== r && "," !== r && ")" !== r);) ;
                    if (t) return new Ie.Selector(t, u, h, f, i);
                    u && s("Extend must be used to extend a selector, it cannot be used on its own")
                }, selectors: function () {
                    for (var e, t; (e = this.selector()) && (t ? t.push(e) : t = [e], o.commentStore.length = 0, e.condition && t.length > 1 && s("Guards are only currently allowed on a single selector."), o.$char(","));) e.condition && s("Guards are only currently allowed on a single selector."), o.commentStore.length = 0;
                    return t
                }, attribute: function () {
                    if (o.$char("[")) {
                        var e, t, n, i = this.entities;
                        return (e = i.variableCurly()) || (e = a(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)), (n = o.$re(/^[|~*$^]?=/)) && (t = i.quoted() || o.$re(/^[0-9]+%/) || o.$re(/^[\w-]+/) || i.variableCurly()), l("]"), new Ie.Attribute(e, n, t)
                    }
                }, block: function () {
                    var e;
                    ...
                    if (o.save(), !o.$re(/^[.#]\(/) || (t = (e = this.mixin.args(!1)).args, n = e.variadic, o.$char(")"))) {
                        ...
                        if (i) return o.forget(), t ? new Ie.mixin.Definition(null, t, i, null, n) : new Ie.DetachedRuleset(i);
                        o.restore()
                    } else o.restore()
                }, ruleset: function () {
                    var e, n, i;
                    ...
                    var e, t, n, r, s, a, l = o.i, u = o.currentChar();
                    if ("." !== u && "#" !== u && "&" !== u && ":" !== u) if (o.save(), e = this.variable() || this.ruleProperty()) {
                        if ((a = "string" == typeof e) && (t = this.detachedRuleset()) && (n = !0), o.commentStore.length = 0, !t) {
                            if (s = !a && e.length > 1 && e.pop().value, t = e[0].value && "--" === e[0].value.slice(0, 2) ? this.permissiveValue() : this.anonymousValue()) return o.forget(), new Ie.Declaration(e, t, !1, s, l, i);
                    ...
                    if (!h()) {
                        ...
                        if (o.save(), a = o.$parseUntil(l)) {
                            if ("string" == typeof a && s("Expected '" + a + "'", "Parse"), 1 === a.length && " " === a[0]) return o.forget(), new Ie.Anonymous("", u);
                            var f = void 0;
                            for (t = 0; t < a.length; t++) if (f = a[t], Array.isArray(f)) c.push(new Ie.Quoted(f[0], f[1], !0, u, i)); else {
                    ...
                    var e, t, n = o.i, r = o.$re(/^@import?\s+/);
                    if (r) {
                        var a = (r ? this.importOptions() : null) || {};
                        if (e = this.entities.quoted() || this.entities.url()) return t = this.mediaFeatures(), o.$char(";") || (o.i = n, s("missing semi-colon or unrecognised media features on import")), t = t && new Ie.Value(t), new Ie.Import(e, t, a, n, i);
                    ...
                    var e, t, n = this.entities, r = [];
                    o.save();
                    do {
                        (e = n.keyword() || n.variable() || n.mixinLookup()) ? r.push(e) : o.$char("(") && (t = this.property(), e = this.value(), o.$char(")") ? t && e ? r.push(new Ie.Paren(new Ie.Declaration(t, e, null, null, o.i, i, !0))) : e ? r.push(new Ie.Paren(e)) : s("badly formed media feature definition") : s("Missing closing ')'", "Parse"))
                    } while (e);
                    ...
                    var e, n, r, a, l = o.i;
                    if (t.dumpLineNumbers && (a = u(l)), o.save(), o.$str("@media")) return e = this.mediaFeatures(), (n = this.block()) || s("media definitions require block statements after any features"), o.forget(), r = new Ie.Media(n, e, l, i), t.dumpLineNumbers && (r.debugInfo = a), r;
                    o.restore()
                }, plugin: function () {
                    var e, t, n, r = o.i;
                    if (o.$re(/^@plugin?\s+/)) {
                        if (n = (t = this.pluginArgs()) ? {
                            pluginArgs: t,
                            isPlugin: !0
                        } : {isPlugin: !0}, e = this.entities.quoted() || this.entities.url()) return o.$char(";") || (o.i = r, s("missing semi-colon on @plugin")), new Ie.Import(e, null, n, r, i);
                    ...
                    var e, n, r, a, l, c, h, f = o.i, p = !0, v = !0;
                    if ("@" === o.currentChar()) {
                    ...
                    var e, t;
                    if (o.save(), o.$char("(")) return (e = this.addition()) && o.$char(")") ? (o.forget(), (t = new Ie.Expression([e])).parens = !0, t) : void o.restore("Expected ')'");
                    o.restore()
                    ...
                    if (e = this.operand()) {
                        for (r = o.isWhitespace(-1); !o.peek(/^\/[*\/]/);) {
                            ...
                            o.forget(), e.parensInOp = !0, t.parensInOp = !0, i = new Ie.Operation(n, [i || e, t], r), r = o.isWhitespace(-1)
                        }
                        return i || e
                    }
                }, addition: function () {
                    ...
                    if (e = this.multiplication()) {
                        for (r = o.isWhitespace(-1); (n = o.$re(/^[-+]\s+/) || !r && (o.$char("+") || o.$char("-"))) && (t = this.multiplication());) e.parensInOp = !0, t.parensInOp = !0, i = new Ie.Operation(n, [i || e, t], r), r = o.isWhitespace(-1);
                        return i || e
                    }
                }, conditions: function () {
                    var e, t, n, i = o.i;
                    if (e = this.condition(!0)) {
                        for (; o.peek(/^,\s*(not\s*)?\(/) && o.$char(",") && (t = this.condition(!0));) n = new Ie.Condition("or", n || e, t, i);
                        return n || e
                    }
                    ...
                    var t, n, i, r, a = this.entities, l = o.i;

                    function u() {
                        return this.addition() || a.keyword() || a.quoted() || a.mixinLookup()
                    }

                    if (t = (u = u.bind(this))()) return o.$char(">") ? r = o.$char("=") ? ">=" : ">" : o.$char("<") ? r = o.$char("=") ? "<=" : "<" : o.$char("=") && (r = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="), r ? (n = u()) ? i = new Ie.Condition(r, t, n, l, !1) : s("expected expression") : i = new Ie.Condition("=", t, new Ie.Keyword("true"), l, !1), i
                }, operand: function () {
                    ...
                    var e, t, n = [], i = o.i;
                    do {
                        (e = this.comment()) ? n.push(e) : ((e = this.addition() || this.entity()) instanceof Ie.Comment && (e = null), e && (n.push(e), o.peek(/^\/[\/*]/) || (t = o.$char("/")) && n.push(new Ie.Anonymous(t, i))))
                    } while (e);
                    ...
                    for (a(/^(\*?)/); a(/^((?:[\w-]+)|(?:[@\$]\{[\w-]+\}))/);) ;
                    if (n.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                        for (o.forget(), "" === n[0] && (n.shift(), r.shift()), t = 0; t < n.length; t++) e = n[t], n[t] = "@" !== e.charAt(0) && "$" !== e.charAt(0) ? new Ie.Keyword(e) : "@" === e.charAt(0) ? new Ie.Variable("@" + e.slice(2, -1), r[t], i) : new Ie.Property("$" + e.slice(2, -1), r[t], i);
                        return n
                    }
                    o.restore()
                }
    ...
    function Te(e, t, n, i) {
        return t.eval(e) ? n.eval(e) : i ? i.eval(e) : new L
    }
    ...
    var Ze = ze = {
        rgb: function (e, t, n) {
            var i = ze.rgba(e, t, n, 1);
            if (i) return i.value = "rgb", i
        }, rgba: function (e, t, n, i) {
            try {
                if (e instanceof f) return i = t ? Ke(t) : e.alpha, new f(e.rgb, i, "rgba");
                var r = [e, t, n].map((function (e) {
                    return n = 255, (t = e) instanceof X && t.unit.is("%") ? parseFloat(t.value * n / 100) : Ke(t);
                    var t, n
                }));
                return i = Ke(i), new f(r, i, "rgba")
            } catch (e) {
            }
        }, hsl: function (e, t, n) {
            var i = ze.hsla(e, t, n, 1);
            if (i) return i.value = "hsl", i
        }, hsla: function (e, t, n, i) {
            try {
                if (e instanceof f) return i = t ? Ke(t) : e.alpha, new f(e.rgb, i, "hsla");
                var r, o;
                ...
                e = Ke(e) % 360 / 360, t = We(Ke(t)), n = We(Ke(n)), i = We(Ke(i)), r = 2 * n - (o = n <= .5 ? n * (t + 1) : n + t - n * t);
                var a = [255 * s(e + 1 / 3), 255 * s(e), 255 * s(e - 1 / 3)];
                return i = Ke(i), new f(a, i, "hsla")
            } catch (e) {
            }
        }, hsv: function (e, t, n) {
            return ze.hsva(e, t, n, 1)
        }, hsva: function (e, t, n, i) {
            var r, o;
            e = Ke(e) % 360 / 360 * 360, t = Ke(t), n = Ke(n), i = Ke(i);
            var s = [n, n * (1 - t), n * (1 - (o = e / 60 - (r = Math.floor(e / 60 % 6))) * t), n * (1 - (1 - o) * t)],
                a = [[0, 3, 1], [2, 0, 1], [1, 0, 3], [1, 2, 0], [3, 1, 0], [0, 1, 2]];
            return ze.rgba(255 * s[a[r][0]], 255 * s[a[r][1]], 255 * s[a[r][2]], i)
        }, hue: function (e) {
            return new X(He(e).h)
        }, saturation: function (e) {
            return new X(100 * He(e).s, "%")
        }, lightness: function (e) {
            return new X(100 * He(e).l, "%")
        }, hsvhue: function (e) {
            return new X(Qe(e).h)
        }, hsvsaturation: function (e) {
            return new X(100 * Qe(e).s, "%")
        }, hsvvalue: function (e) {
            return new X(100 * Qe(e).v, "%")
        }, red: function (e) {
            ...
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.s += i.s * t.value / 100 : i.s += t.value / 100, i.s = We(i.s), Je(e, i)
        }, desaturate: function (e, t, n) {
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.s -= i.s * t.value / 100 : i.s -= t.value / 100, i.s = We(i.s), Je(e, i)
        }, lighten: function (e, t, n) {
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.l += i.l * t.value / 100 : i.l += t.value / 100, i.l = We(i.l), Je(e, i)
        }, darken: function (e, t, n) {
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.l -= i.l * t.value / 100 : i.l -= t.value / 100, i.l = We(i.l), Je(e, i)
        }, fadein: function (e, t, n) {
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.a += i.a * t.value / 100 : i.a += t.value / 100, i.a = We(i.a), Je(e, i)
        }, fadeout: function (e, t, n) {
            var i = He(e);
            return void 0 !== n && "relative" === n.value ? i.a -= i.a * t.value / 100 : i.a -= t.value / 100, i.a = We(i.a), Je(e, i)
        }, fade: function (e, t) {
            var n = He(e);
            return n.a = t.value / 100, n.a = We(n.a), Je(e, n)
        }, spin: function (e, t) {
            var n = He(e), i = (n.h + t.value) % 360;
            return n.h = i < 0 ? 360 + i : i, Je(e, n)
        }, mix: function (e, t, n) {
            n || (n = new X(50));
            var i = n.value / 100, r = 2 * i - 1, o = He(e).a - He(t).a,
            ...
            return ze.desaturate(e, new X(100))
        }, contrast: function (e, t, n, i) {
            if (!e.rgb) return null;
            if (void 0 === n && (n = ze.rgba(255, 255, 255, 1)), void 0 === t && (t = ze.rgba(0, 0, 0, 1)), t.luma() > n.luma()) {
                var r = n;
                n = t, t = r
            }
            return i = void 0 === i ? .43 : Ke(i), e.luma() < i ? n : t
        }, argb: function (e) {
            return new L(e.toARGB())
        }, color: function (e) {
            if (e instanceof ue && /^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})$/i.test(e.value)) {
                var t = e.value.slice(1);
                return new f(t, void 0, "#" + t)
            }
    ...
    function Ye(e, t, n) {
        var i, r, o, s, a = t.alpha, l = n.alpha, u = [];
        o = l + a * (1 - l);
    ...
    for (var et in Xe) Xe.hasOwnProperty(et) && (Ye[et] = Ye.bind(null, Xe[et]));
    var tt = function (e) {
        ...
        _SELF: function (e) {
            ...
            var n, i, r = [];
            i = !e.value || e instanceof ue ? e.ruleset ? e.ruleset.rules : e.rules ? e.rules : Array.isArray(e) ? e : [e] : Array.isArray(e.value) ? e.value : [e.value];
            var o = "@value", s = "@key", a = "@index";
            ...
            return new Q([new F([new y("", "&")])], r, t.strictImports, t.visibilityInfo()).eval(this.context)
        }
    }, it = function (e, t, n) {
    ...
    var st, at = function (e, t) {
        ...
        })).join(this.context.compress ? "," : ", "), new L((e ? "min" : "max") + "(" + t + ")"))
    }, lt = {
        min: function () {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            return at(!0, e)
            ...
            if ("number" == typeof e && "number" == typeof t) e = new X(e), t = new X(t); else if (!(e instanceof X && t instanceof X)) throw{
                type: "Argument",
        ...
        e: function (e) {
            ...
            return new L(encodeURI(e.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g, "%23").replace(/;/g, "%3B").replace(/\(/g, "%28").replace(/\)/g, "%29"))
        }, replace: function (e, t, n, i) {
            var r = e.value;
            return n = "Quoted" === n.type ? n.value : n.toCSS(), r = r.replace(new RegExp(t.value, i ? i.value : ""), n), new ue(e.quote || "", r, e.escaped)
        }, "%": function (e) {
        ...
        if (void 0 === t) throw{type: "Argument", message: "missing the required second argument to isunit."};
        if ("string" != typeof (t = "string" == typeof t.value ? t.value : t)) throw{
            type: "Argument",
            message: "Second argument to isunit should be a unit or a string."
        };
        return e instanceof X && e.unit.is(t) ? O.True : O.False
    }, ft = {
        isruleset: function (e) {
            ...
            return ht(e, "em")
        }, isunit: ht, unit: function (e, t) {
            if (!(e instanceof X)) throw{
                type: "Argument",
                message: "the first argument to unit must be a number" + (e instanceof te ? ". Have you forgotten parenthesis?" : "")
            };
            return t = t ? t instanceof O ? t.value : t.toCSS() : "", new X(e.value, t)
        }, "get-unit": function (e) {
            return new L(e.unit)
        }
    }, pt = function (e) {
        var t = {functionRegistry: J, functionCaller: re};
        return J.addMultiple(Ge), J.add("default", H.eval.bind(H)), J.addMultiple(Ze), J.addMultiple(Ye), J.addMultiple(function (e) {
            var t = function (e, t) {
            ...
            return {
                "data-uri": function (n, i) {
                    i || (i = n, n = null);
                    var r = n && n.value, o = i.value, s = this.currentFileInfo,
                        a = s.rewriteUrls ? s.currentDirectory : s.entryPath, l = o.indexOf("#"), u = "";
                    -1 !== l && (u = o.slice(l), o = o.slice(0, l));
                    var c = k(this.context);
                    c.rawBuffer = !0;
                    var h = e.getFileManager(o, a, c, e, !0);
                    if (!h) return t(this, i);
                    var f = !1;
                    if (n) f = /;base64$/.test(r); else {
                        if ("image/svg+xml" === (r = e.mimeLookup(o))) f = !1; else {
                    ...
                    if (!v.contents) return Ce.warn("Skipped data-uri embedding of " + o + " because file not found"), t(this, i || n);
                    var d = v.contents;
                    if (f && !e.encodeBase64) return t(this, i);
                    var m = "data:" + r + "," + (d = f ? e.encodeBase64(d) : encodeURIComponent(d)) + u;
                    return new ce(new ue('"' + m + '"', m, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
                }
            }
        }(e)), J.addMultiple(nt), J.addMultiple(rt), J.addMultiple(lt), J.addMultiple(ut), J.addMultiple({
            "svg-gradient": function (e) {
                var t, n, i, r, o, s, a, l, u = "linear", c = 'x="0" y="0" width="1" height="1"', h = {compress: !1},
                    p = e.toCSS(h);
                ...
                for (i = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><' + u + 'Gradient id="g" ' + n + ">", r = 0; r < t.length; r += 1) t[r] instanceof ie ? (o = t[r].value[0], s = t[r].value[1]) : (o = t[r], s = void 0), o instanceof f && ((0 === r || r + 1 === t.length) && void 0 === s || s instanceof X) || v(), a = s ? s.toCSS(h) : 0 === r ? "0%" : "100%", l = o.alpha, i += '<stop offset="' + a + '" stop-color="' + o.toRGB() + '"' + (l < 1 ? ' stop-opacity="' + l + '"' : "") + "/>";
                return i += "</" + u + "Gradient><rect " + c + ' fill="url(#g)" /></svg>', i = encodeURIComponent(i), new ce(new ue("'" + (i = "data:image/svg+xml," + i) + "'", i, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
            }
        }), J.addMultiple(ft), t
    }, vt = function (e, t) {
        var n;
        void 0 === t && (t = {});
        var i = t.variables, r = new q.Eval(t);
        "object" != typeof i || Array.isArray(i) || (i = Object.keys(i).map((function (e) {
            var t = i[e];
            return t instanceof Ie.Value || (t instanceof Ie.Expression || (t = new Ie.Expression([t])), t = new Ie.Value([t])), new Ie.Declaration("@" + e, t, !1, null, 0)
        })), r.frames = [new Ie.Ruleset(null, i)]);
        var o, s,
            a = [new Ue.JoinSelectorVisitor, new Ue.MarkVisibleSelectorsVisitor(!0), new Ue.ExtendVisitor, new Ue.ToCSSVisitor({compress: Boolean(t.compress)})],
            l = [];
        if (t.pluginManager) {
            s = t.pluginManager.visitor();
            for (var u = 0; u < 2; u++) for (s.first(); o = s.get();) o.isPreEvalVisitor ? 0 !== u && -1 !== l.indexOf(o) || (l.push(o), o.run(e)) : 0 !== u && -1 !== a.indexOf(o) || (o.isPreVisitor ? a.unshift(o) : a.push(o))
        }
        n = e.eval(r);
        for (u = 0; u < a.length; u++) a[u].run(n);
        if (t.pluginManager) for (s.first(); o = s.get();) -1 === a.indexOf(o) && -1 === l.indexOf(o) && o.run(n);
        return n
    }, dt = function () {
        function e(e) {
    ...
    var gt, yt, bt = function (e, t) {
        var n, i = function (e) {
            return function () {
                ...
                return t.prototype.removeBasepath = function (e) {
                    ...
                    if (e) {
                        ...
                        if (s = (r = e.split("\n"))[r.length - 1], t && t.filename) if (i) for (l = 0; l < r.length; l++) this._sourceMapGenerator.addMapping({
                            generated: {
                    ...
                    if (this._rootNode.genCSS(e, this), this._css.length > 0) {
                        var i = void 0, r = JSON.stringify(this._sourceMapGenerator.toJSON());
            ...
            return function () {
                ...
                return t.prototype.toCSS = function (t) {
                    ...
                    try {
                        ...
                        o && Ce.warn("The compress option has been deprecated. We recommend you use a dedicated css minifier, for instance see less-plugin-clean-css.");
                        var s = {
                            compress: o,
                    ...
                    if (t.pluginManager) for (var a = t.pluginManager.getPostProcessors(), l = 0; l < a.length; l++) r.css = a[l].process(r.css, {
                        sourceMap: i,
                        options: t,
            ...
            return function () {
                ...
                return t.prototype.push = function (t, n, i, r, o) {
                    var s = this, a = this.context.pluginManager.Loader;
                    this.queue.push(t);
                    var l = function (e, n, i) {
                        s.queue.splice(s.queue.indexOf(t), 1);
                        var a = i === s.rootFilename;
                        if (r.optional && e) o(null, {rules: []}, !1, null), Ce.info("The file " + i + " was skipped because it was not found and the import was marked optional."); else {
                            var l = s.files;
                            -1 === l.indexOf(i) && l.push(i), e && !s.error && (s.error = e), o(e, n, a, i)
                        }
                    }, u = {
                    ...
                    if (c) {
                        var h, f, p = function (e) {
                            var t, n = e.filename, o = e.contents.replace(/^\uFEFF/, "");
                            ...
                            var h = new q.Parse(s.context);
                            h.processImports = !1, s.contents[n] = o, (i.reference || r.reference) && (u.reference = !0), r.isPlugin ? (t = a.evalPlugin(o, h, s, r.pluginArgs, u)) instanceof R ? l(t, null, n) : l(null, t, n) : r.inline ? l(null, o, n) : new je(h, s, u).parse(o, (function (e, t) {
                                l(e, t, n)
                            }))
                        }, v = k(this.context);
                        n && (v.ext = r.isPlugin ? ".js" : ".less"), r.isPlugin ? (v.mime = "application/javascript", v.syncImport ? h = a.loadPluginSync(t, i.currentDirectory, v, e, c) : f = a.loadPlugin(t, i.currentDirectory, v, e, c)) : v.syncImport ? h = c.loadFileSync(t, i.currentDirectory, v, e) : f = c.loadFile(t, i.currentDirectory, v, e, (function (e, t) {
                            e ? l(e) : p(t)
                        })), h ? h.filename ? p(h) : l(h) : f && f.then(p, l)
                    } else l({message: "Could not find a file-manager for " + t})
                }, t
            }()
        }(e), l = function (e, t, n) {
            var i = function (e, n, r) {
                if ("function" == typeof n ? (r = n, n = A(this.options, {})) : n = A(this.options, n || {}), !r) {
                    var o = this;
            ...
            return i
        }(0, o), u = function (e, t, n) {
            var i = function (e, t, r) {
                if ("function" == typeof t ? (r = t, t = A(this.options, {})) : t = A(this.options, t || {}), !r) {
                    var o = this;
                ...
                if (t.pluginManager = l, s = new q.Parse(t), t.rootFileInfo) a = t.rootFileInfo; else {
                    var u = t.filename || "input", c = u.replace(/[^\/\\]*$/, "");
                    (a = {
                        filename: u,
                ...
                this.importManager = h, t.plugins && t.plugins.forEach((function (e) {
                    var t, n;
                    if (e.fileContent) {
                        if (n = e.fileContent.replace(/^\uFEFF/, ""), (t = l.Loader.evalPlugin(n, s, h, e.options, e.filename)) instanceof R) return r(t)
                    } else l.addPlugin(e)
                })), new je(s, h, a).parse(e, (function (e, n) {
                    if (e) return r(e);
                    r(null, n, h, t)
                }), t)
            };
        ...
        for (var d in f.tree) if ("function" == typeof (n = f.tree[d])) v[d.toLowerCase()] = p(n); else for (var m in v[d] = Object.create(null), n) v[d][m.toLowerCase()] = p(n[m]);
        return f.parse = f.parse.bind(v), f.render = f.render.bind(v), v
    }, wt = {}, xt = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return o(t, e), t.prototype.alwaysMakePathsAbsolute = function () {
            return !0
        }, t.prototype.join = function (e, t) {
            return e ? this.extractUrlParts(t, e).path : t
        }, t.prototype.doXHR = function (e, t, n, i) {
            var r = new XMLHttpRequest, o = !gt.isFileProtocol || gt.fileAsync;
            ...
            var r = this.extractUrlParts(e, window.location.href).url, o = this;
            return new Promise((function (e, t) {
                if (n.useFileCache && wt[r]) try {
                    var i = wt[r];
                    return e({contents: i, filename: r, webInfo: {lastModified: new Date}})
                } catch (e) {
                    return t({filename: r, message: "Error loading file " + r + " error was " + e.message})
                }
                o.doXHR(r, n.mime, (function (t, n) {
                    wt[r] = t, e({contents: t, filename: r, webInfo: {lastModified: n}})
                }), (function (e, n) {
        ...
        return {
            add: function (o, s) {
                r.errorReporting && "html" !== r.errorReporting ? "console" === r.errorReporting ? function (e, t) {
                    ...
                    e.line && (a(e, 0, ""), a(e, 1, "line"), a(e, 2, ""), s += " on line " + e.line + ", column " + (e.column + 1) + ":\n" + o.join("\n")), e.stack && (e.extract || r.logLevel >= 4) && (s += "\nStack Trace\n" + e.stack), i.logger.error(s)
                }(o, s) : "function" == typeof r.errorReporting && r.errorReporting("add", o, s) : function (i, o) {
                    var s, a, l = "less-error-message:" + e(o || ""), u = t.document.createElement("div"), c = [],
                        h = i.filename || o, f = h.match(/([^\/]+(\?.*)?)$/)[1];
                    u.id = l, u.className = "less-error-message", a = "<h3>" + (i.type || "Syntax") + "Error: " + (i.message || "There is an error in your .less file") + '</h3><p>in <a href="' + h + '">' + f + "</a> ";
                    ...
                    i.line && (p(i, 0, ""), p(i, 1, "line"), p(i, 2, ""), a += "on line " + i.line + ", column " + (i.column + 1) + ":</p><ul>" + c.join("") + "</ul>"), i.stack && (i.extract || r.logLevel >= 4) && (a += "<br/>Stack Trace</br />" + i.stack.split("\n").slice(1).join("<br/>")), u.innerHTML = a, n(t.document, [".less-error-message ul, .less-error-message li {", "list-style-type: none;", "margin-right: 15px;", "padding: 4px 0;", "margin: 0;", "}", ".less-error-message label {", "font-size: 12px;", "margin-right: 15px;", "padding: 4px 0;", "color: #cc7777;", "}", ".less-error-message pre {", "color: #dd6666;", "padding: 4px 0;", "margin: 0;", "display: inline-block;", "}", ".less-error-message pre.line {", "color: #ff0000;", "}", ".less-error-message h3 {", "font-size: 20px;", "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a", "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;", "border-bottom: 1px dashed red;", "}"].join("\n"), {title: "error-message"}), u.style.cssText = ["font-family: Arial, sans-serif", "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px", "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"].join(";"), "development" === r.env && (s = setInterval((function () {
                        var e = t.document, n = e.body;
    ...
    if (window.less) for (var _t in window.less) window.less.hasOwnProperty(_t) && (kt[_t] = window.less[_t]);
    !function (e, n) {
        t(n, i(e)), void 0 === n.isFileProtocol && (n.isFileProtocol = /^(file|(chrome|safari)(-extension)?|resource|qrc|app):/.test(e.location.protocol)), n.async = n.async || !1, n.fileAsync = n.fileAsync || !1, n.poll = n.poll || (n.isFileProtocol ? 1e3 : 1500), n.env = n.env || ("127.0.0.1" == e.location.hostname || "0.0.0.0" == e.location.hostname || "localhost" == e.location.hostname || e.location.port && e.location.port.length > 0 || n.isFileProtocol ? "development" : "production");
        var r = /!dumpLineNumbers:(comments|mediaquery|all)/.exec(e.location.hash);
        r && (n.dumpLineNumbers = r[1]), void 0 === n.useFileCache && (n.useFileCache = !0), void 0 === n.onReady && (n.onReady = !0), n.relativeUrls && (n.rewriteUrls = "all")
    }(window, kt), kt.plugins = kt.plugins || [], window.LESS_PLUGINS && (kt.plugins = kt.plugins.concat(window.LESS_PLUGINS));
    var At, Mt, Pt, Et = function (e, i) {
        var r = e.document, o = bt();
        o.options = i;
        var s = o.environment, a = St(i, o.logger), l = new a;
        s.addFileManager(l), o.FileManager = a, o.PluginLoader = It, function (e, t) {
        ...
        var u = Ct(e, o, i), c = o.cache = i.cache || function (e, t, n) {
            var i = null;
            ...
            return {
                setCSS: function (e, t, r, o) {
                    ...
                    var r = i && i.getItem(e), o = i && i.getItem(e + ":timestamp"), s = i && i.getItem(e + ":vars");
        ...
        !function () {
            ...
            J.addMultiple(t)
        }(o.environment), i.functions && o.functions.functionRegistry.addMultiple(i.functions);
        var h = /^text\/(x-)?less$/;
        ...
        function v(e) {
            for (var t, n = r.getElementsByTagName("style"), s = 0; s < n.length; s++) if ((t = n[s]).type.match(h)) {
                var a = f(i);
                a.modifyVars = e;
                var l = t.innerHTML || "";
        ...
        function d(e, n, r, a, h) {
            ...
            t(p, e), p.mime = e.type, h && (p.modifyVars = h), l.loadFile(e.href, null, p, s).then((function (t) {
                !function (t) {
                    var i = t.contents, s = t.filename, h = t.webInfo,
                        f = {currentDirectory: l.getPath(s), filename: s, rootFilename: s, rewriteUrls: p.rewriteUrls};
                    ...
                    u.remove(s), p.rootFileInfo = f, o.render(i, p, (function (t, r) {
        ...
        return o.watch = function () {
            return o.watchMode || (o.env = "development", "development" === o.env && (o.watchTimer = setInterval((function () {
                o.watchMode && (l.clearFileCache(), m((function (t, i, r, o, s) {
            ...
            o.sheets = [];
            for (var t = 0; t < e.length; t++) ("stylesheet/less" === e[t].rel || e[t].rel.match(/stylesheet/) && e[t].type.match(h)) && o.sheets.push(e[t])
            ...
            return (t || r) && !1 !== r && l.clearFileCache(), new Promise((function (r, s) {
                var a, l, c, h;
                a = l = new Date, 0 === (h = o.sheets.length) ? (l = new Date, c = l - a, o.logger.info("Less has finished and no sheets were loaded."), r({
                    startTime: a,
                    endTime: l,
                    totalMilliseconds: c,
                    ...
                    v.local ? o.logger.info("Loading " + p.href + " from cache.") : o.logger.info("Rendered " + p.href + " successfully."), n(e.document, i, p), o.logger.info("CSS for " + p.href + " generated in " + (new Date - l) + "ms"), 0 === --h && (c = new Date - a, o.logger.info("Less has finished. CSS generated in " + c + "ms"), r({
                        startTime: a,
                        endTime: l,
                        totalMilliseconds: c,
                        sheets: o.sheets.length
